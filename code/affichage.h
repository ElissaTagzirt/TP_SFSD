...
char menu[]="Creation Fichiers#Affichage#Mise a jour#Generateur Graphs#Quitter";
...
void hell ()
{
    ...
    printf("                     .-/|       ~~~~~~ ***** ~~~~~~          \\ /           ~~~~~~ ***** ~~~~~~        |\\-.\n");
    printf("                     ||||                                     :                                       ||||\n");
    printf("                     ||||  Ecole Superieure d'Informatique    :   Cycle preparatoire integre (CP2)    ||||\n");
    printf("                     ||||");
    Color(11,16);
    printf("              _");
    textcolor(15);
    ...
    printf("                     ||||                                     :                                       ||||\n");
    printf("                     ||||                                     :                                       ||||\n");
    printf("                     ||||  Manipulation d'un fichier T70F     :                                       ||||\n");
    printf("                     ||||  fichiers crees :                   :");
    ...
    printf("                     |||| lors des operations de mise a jour  :                                       ||||\n");
    printf("                     ||||     ^                               :");
    ...
    printf("       Ens. KERMI Adel ");
    Color(15,16);
    printf("                ||||\n");
    printf("                     ||||     |     |   |    |   |            :                                       ||||\n");
    printf("                     ||||     |_____|___|____|___|____ >      :                                       ||||\n");
    printf("                     ||||                                     :                                       ||||\n");
    printf("                     ||||          LireDir   EcrireDir        :                                       ||||\n");
    printf("                     ||||____________________________________ : ______________________________________||||\n");
    printf("                     ||/=====================================\\:/=======================================\\||\n");
    printf("                     `--------------------------------------~___~---------------------------------------''\n\n");
    textcolor(14);
